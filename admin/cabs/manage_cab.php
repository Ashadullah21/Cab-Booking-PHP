...
<div class="card card-outline card-purple rounded-0">
	...
	<div class="card-body">
		<form action="" id="cab-form">
			...
			<div class="form-group">
				<label for="driver_license_no" class="control-label">Driver's License #</label>
				<input name="driver_license_no" id="driver_license_no" type="text" class="form-control rounded-0" value="<?php echo isset($driver_license_no) ? $driver_license_no : ''; ?>" required>
			</div>
